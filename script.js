        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'a3083b0c-4141-4305-bb6b-8b8d9d6d3702',
                name: data.name || '',
                email: data.email || '',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Spike uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
